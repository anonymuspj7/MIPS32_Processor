...
HD_PWD='C:/Users/prana/Downloads/Processor/Processor.runs/mem_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_ram.tcl
