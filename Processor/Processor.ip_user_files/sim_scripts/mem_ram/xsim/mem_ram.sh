...
#
# Script generated by Vivado on Tue Nov 12 20:10:09 +0530 2024
...
#
# Usage        : mem_ram.sh
#                mem_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mem_ram.sh [-reset_run]
#                mem_ram.sh [-reset_log]
#                mem_ram.sh [-help]
#
...
# script info
echo -e "mem_ram.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mem_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mem_ram xil_defaultlib.mem_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mem_ram -key {Behavioral:sim_1:Functional:mem_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mem_ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mem_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mem_ram.sh [-help]\n\
Usage: mem_ram.sh [-step]\n\
Usage: mem_ram.sh [-lib_map_path]\n\
Usage: mem_ram.sh [-reset_run]\n\
Usage: mem_ram.sh [-reset_log]\n\
Usage: mem_ram.sh [-keep_index]\n\
Usage: mem_ram.sh [-noclean_files]\n\n\
